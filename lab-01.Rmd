...
**There is at least one value in the n_2021 column that is NA which means it cannot be used to find the mean and median values.**
...
**There is a higher frequency of higher visitor counts. The outliers are to the lower end.**
